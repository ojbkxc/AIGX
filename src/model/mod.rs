...
pub fn default_model_map() -> HashMap<String, String> {
    ...
    m.insert(
        ...
        "@cf/meta/llama-4-maverick-17b-128e-instruct".into(),
    );
    m.insert(
    ...
    m.insert(
        "deepseek-v3".into(),
        "@cf/deepseek-ai/deepseek-v3-0324".into(),
    );
    m.insert(
    ...
    m.insert(
        "qwen-2.5-72b".into(),
        "@cf/qwen/qwen2.5-72b-instruct".into(),
    );
    m.insert(
    ...
    m.insert(
        "qwen-2.5-7b".into(),
        "@cf/qwen/qwen2.5-7b-instruct-awq".into(),
    );
    ...
    m.insert(
        ...
        "@cf/deepseek-ai/deepseek-coder-6.7b-instruct".into(),
    );
    m.insert(
        "llama-3.2-3b".into(),
    ...
    m.insert(
        "codellama-34b".into(),
        "@cf/codellama/codellama-34b-instruct".into(),
    );
    m.insert(
        "codellama-13b".into(),
        "@cf/codellama/codellama-13b-instruct".into(),
    );
    m.insert(
        "codellama-7b".into(),
        "@cf/codellama/codellama-7b-instruct".into(),
    );
    m.insert(
        "mixtral-8x7b".into(),
        "@cf/mistral/mixtral-8x7b-instruct".into(),
    );
    ...
    m.insert(
        "phi-3-mini".into(),
        "@cf/microsoft/phi-3-mini-4k-instruct".into(),
    );
    m.insert("phi-2".into(), "@cf/microsoft/phi-2".into());
    m.insert(
        "internlm2-7b".into(),
        "@cf/internlm/internlm2-7b-instruct".into(),
    );

    // 向量嵌入（Embeddings）模型
    m.insert("bge-m3".into(), "@cf/baai/bge-m3".into());
    m.insert(
        "bge-base-en-v1.5".into(),
    ...
    m.insert(
        ...
        "@cf/qwen/qwen3-embedding-0.6b".into(),
    );
    m.insert(
        "embeddinggemma-300m".into(),
        "@cf/google/embeddinggemma-300m".into(),
    );
    ...
    m.insert(
        "flux-1-schnell".into(),
        "@cf/black-forest-labs/flux-1-schnell".into(),
    );
    m.insert(
        "flux-1-dev".into(),
        "@cf/black-forest-labs/flux-1-dev".into(),
    );
    m.insert(
        "sdxl".into(),
        "@cf/stabilityai/stable-diffusion-xl-base-1.0".into(),
    );
    ...
    m.insert(
        "whisper-tiny-en".into(),
        "@cf/openai/whisper-tiny-en".into(),
    );
    m.insert(
        "whisper-large-v3-turbo".into(),
        "@cf/openai/whisper-large-v3-turbo".into(),
    );

    // 视觉模型
    m.insert(
        "moondream3.1-9B-A2B".into(),
        "@cf/moondream/moondream3.1-9B-A2B".into(),
    );
