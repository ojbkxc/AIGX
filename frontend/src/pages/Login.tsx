...
export default function Login(): JSX.Element {
  ...
  // OAuth 登录：Google / GitHub / LinuxDO（未配置时后端会返回明确错误）
  const handleOAuthLogin = (provider: 'google' | 'github' | 'linuxdo'): void => {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <button
          ...
          style={{ width: '100%', justifyContent: 'center', padding: '9px', fontSize: '13px', gap: '8px', marginTop: '8px' }}
        >
          {/* LinuxDO 品牌图标（参照 new-api icon-linuxdo） */}
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" role="img" style={{ width: '15px', height: '15px', flexShrink: 0 }}>
            <title>LinuxDO</title>
            <path
